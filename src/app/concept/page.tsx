      ...
      <main className="pt-16">
        <section className="py-16 md:py-24">
          <div className="max-w-[760px] mx-auto px-5 lg:px-10">
            ...
            <h1 className="text-3xl md:text-4xl font-bold leading-tight mb-8" style={{ fontFamily: "'Noto Serif JP', serif", color: "#3C6B4F" }}>
              食べられる森とは
            </h1>

            <div className="space-y-5 text-sm md:text-[15px] leading-[2]" style={{ color: "#1A2B1E" }}>
              <p>
            ...
            <h2 className="text-xl md:text-2xl font-bold mt-14 mb-8" style={{ fontFamily: "'Noto Serif JP', serif", color: "#3C6B4F" }}>
              さまざまな食べられる森
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {FOREST_EXAMPLES.map((f) => (
                <div key={f.title} className="rounded-2xl p-6" style={{ border: "1px solid rgba(0,95,2,0.15)" }}>
                  ...
                  <p className="text-sm leading-[1.9]" style={{ color: "#1A2B1E" }}>{f.desc}</p>
                </div>
              ))}
            </div>

            <div className="mt-14 text-center">
              <a href="/#search" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full text-sm font-medium text-white transition-opacity hover:opacity-90" style={{ backgroundColor: "#3C6B4F" }}>
                各地の食べられる森を見る →
              </a>
            </div>
          </div>
