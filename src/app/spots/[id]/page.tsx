            ...
            <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-center">
              ...
              <div className="order-1 md:order-2 flex-shrink-0">
                <div
                  ...
                  style={{ width: "320px", height: "240px", backgroundColor: "#FFFFFF", boxShadow: "0 4px 24px rgba(0,0,0,0.10)" }}
                >
                  {spot.img ? (
          ...
          <section className="py-16 md:py-20" style={{ backgroundColor: "#FFFFFF" }}>
            <div className="max-w-[800px] mx-auto px-5 lg:px-10">
              <span
                ...
                style={{ height: "24px", lineHeight: "24px", borderRadius: "12px", backgroundColor: "#005F02", color: "#005F02" }}
              >
                拠点の内容
              </span>
              <div
            ...
            <div className="max-w-[1200px] mx-auto px-5 lg:px-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                {related.map((s) => (
                  ...
                  >
                    <div style={{ height: "140px", backgroundColor: "#FFFFFF" }} className="overflow-hidden">
                      {s.img
        ...
        <section className="py-16" style={{ backgroundColor: "#FFFFFF" }}>
          <div className="max-w-[1200px] mx-auto px-5 lg:px-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href={`/contact?spot=${encodeURIComponent(spot.name)}`}
                className="inline-flex items-center justify-center px-8 py-3.5 rounded-full text-white text-sm font-medium hover:opacity-90 transition-opacity"
                style={{ backgroundColor: "#005F02" }}
              >
                お問い合わせ
              </a>
              <a
                href="/spots"
                className="inline-flex items-center justify-center px-8 py-3.5 rounded-full text-sm font-medium border-2 hover:bg-white transition-colors"
